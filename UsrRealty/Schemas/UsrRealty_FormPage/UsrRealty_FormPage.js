		...
		viewConfigDiff: /**SCHEMA_VIEW_CONFIG_DIFF*/[
			...
			},
			{
				...
				"values": {
					...
					"visible": true,
					"clicked": {
						"request": "usr.RunGetAvgPriceWebServiceButtonRequest"
					},
					"icon": "sum-icon"
				},
        ...
        handler: async (request, next) => {
			...
			
			{
				...
				handler: async (request, next) => {
					...
					var typeObject = await request.$context.PDS_UsrType_d73o10i;
					var typeId = "";
					if (typeObject) {
					...
					var offerTypeObject = await request.$context.PDS_UsrOfferType_zvxvozg;
					var offerTypeId = "";
					if (offerTypeObject) {
